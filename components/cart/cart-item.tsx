...
const CartItem = ({ product }: CartProductsType) => {
  ...
  const buyNow = () => console.log("order placed");
  ...
  return (
    <Card className="flex flex-row gap-6 border border-gray-200 rounded-xl shadow-sm p-4 hover:shadow-md transition mb-4">
      {/* ================================================================= */}
